<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientAnte.aspx.cs" Inherits="PatientAnte" %>
...
<a href="Documents.aspx" class="list-group-item list-group-item-action bg-light">Document</a></div>
...
<div class="container-fluid">
    <div class="form-style-10">
        <h1>Register Patient Antecedent<span>formulaire d'ajout d'un nouveau Patient Antecedent</span></h1>
        ...
        <asp:Label ID="Label1" runat="server" Text="Antecedent :"></asp:Label><br />
