<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hospitalisation.aspx.cs" Inherits="Hospitalisation" %>
...
<div class="container-fluid">
    <div class="form-style-10">
        <h1>Register Hospitalisation<span>formulaire d'ajout d'un nouveau Hospitalisation</span></h1>
        ...
        <asp:Label ID="Label1" runat="server" Text="Chambre :"></asp:Label><br />
        ...
        <br /><br />
        <asp:Button ID="Button1" runat="server" Text="Ajouter" OnClick="Button1_Click" /><br />
        </div>
        </div>
        </div>
    </div>
